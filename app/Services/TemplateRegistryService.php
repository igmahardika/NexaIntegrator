        ...
        return [
            'access-code' => [
                ...
                'default_config' => [
                    ...
                    'promo_image_3'   => '/images/nexa/promo-slide-3.jpg',
                    'card_bg'         => '#ffffff',
                    'promo_enabled'   => true,
            ...
            'hotel-pms' => [
                'id'            => 'hotel-pms',
                'name'          => 'Hotel PMS (Room & Guest Name)',
                'method'        => 'hotel-pms',
                'category'      => 'Hospitality & Hotel Guests',
                'description'   => 'Metode login khusus tamu hotel menggunakan Nomor Kamar (Room #) dan Nama Belakang (Last Name). Terhubung langsung dengan sistem PMS hotel.',
                'preview_badge' => 'Hotel PMS',
                'accent'        => '#1e3a8a',
                'icon'          => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
                'default_config' => [
                    'brand_name'        => 'Grand Hotel & Resort',
                    'brand_tagline'     => 'In-Room High-Speed Wi-Fi',
                    'instagram'         => 'hotel.resort',
                    'logo_url'          => '/images/nexa/logo-hotspot-color.png',
                    'logo_white'        => '/images/nexa/logo-hotspot-white.png',
                    'logo_nexa'         => '/images/nexa/logo-nexa-color.png',
                    'topbar_color'      => '#1e3a8a',
                    'topbar_title'      => 'Guest Room Login',
                    'hero_title'        => 'Selamat Datang Tamu Terhormat',
                    'hero_subtitle'     => 'Silakan masukkan nomor kamar dan nama belakang Anda untuk terhubung ke internet',
                    'input_placeholder' => 'Nomor Kamar (Contoh: 301)',
                    'button_text'       => 'Verifikasi & Hubungkan',
                    ...
                    'card_bg'           => '#ffffff',
                    'promo_enabled'     => true,
                    'promo_badge'       => 'Room WiFi',
                    'promo_title'       => 'Layanan Eksklusif Kamar',
                    'promo_text'        => 'Akses internet tanpa batas kuota selama masa menginap Anda di hotel kami.',
                    'promo_link'        => '',
                    'tos_text'          => 'Koneksi aktif hingga waktu check-out kamar Anda.',
                    'custom_css'        => '',
                ],
            ],
        ];
